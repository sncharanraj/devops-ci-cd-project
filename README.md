...
This project demonstrates an end-to-end **CI/CD pipeline** for deploying a Dockerized Flask application to an **Azure Virtual Machine** using **GitHub Actions**, **GitHub Container Registry (GHCR)**, and **Docker**.
...
- **Flask** – Simple Python application
...
docker pull ghcr.io/<username>/devops-app:latest
docker stop devops-app || true
docker rm devops-app || true
docker run -d --name devops-app -p 5000:5000 ghcr.io/<username>/devops-app:latest
...
Fixed GHCR package permission errors by using a Classic PAT

Resolved SSH authentication issues by correctly configuring private key

Replaced local WSL deployment target with Azure VM due to network isolation

Enabled public access by opening port 5000 in Azure NSG

Ensured Flask app binds to 0.0.0.0 so Docker can expose it externally

#📘 Conclusion

This project demonstrates end-to-end DevOps practices including CI/CD automation, Docker containerization, cloud deployment on Azure, image registry management, secure SSH-based delivery, and real production-style troubleshooting.
